...
local globalkeys = gears.table.join(
	...
	awful.key({modkey}, "r",
		function() awful.spawn("ranger") end,
	...
	awful.key({modkey}, "space",
		function() awful.util.spawn("/home/sagacity/.config/rofi/launchers/ribbon/launcher.sh", false) end,
		{ description = "run prompt", group = "apps" }
	),
	awful.key({modkey, "Shift"}, "space",
		function() awful.util.spawn("/home/sagacity/.config/rofi/launchers/ribbon/taskLauncher.sh", false) end,
	...
	awful.key({modkey, "Control"}, "Print",
		function() awful.spawn.with_shell("flameshot full -p ~/Pictures/Screenshots-AwesomeWM") end,
